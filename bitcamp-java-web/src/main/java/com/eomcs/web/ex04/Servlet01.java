...
// 웹브라우저에서 웹서버에 자원을 요청하는 방법
// 1) 서블릿 클래스를 실행하고 싶을 때
// => 서블릿 클래스의 실제 위치:
// 톰캣배치폴더/wtpwebapps/bitcamp-java-web/WEB-INF/classes/com/eomcs/web/ex04/s1
// 요청:
// 해당 서블릿을 서버에 등록할 때 사용한 URL을 사용해야 한다. /WEB-INF/하고 어쩌구 이렇게 쓰면 안됨
// => http://localhost:9999/bitcamp-java-web/ex04/s1
