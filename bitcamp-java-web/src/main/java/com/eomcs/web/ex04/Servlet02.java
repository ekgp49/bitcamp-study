...
public class Servlet02 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse res)
    ...
    req.setCharacterEncoding("UTF-8"); // 반드시 붙이기 반드시 붙이기 반드시 붙이기
    // 이걸 붙여야 UTF-8을 UCS-2로 정상적으로 바꿈. 자바는 UCS-2를 쓰기 때문에 반듯 ㅣ바꿔야함
    ...
    // => 주의!
    // 반드시 getParamter()를 최초로 호출하기 전(필터에서 호출하든 서블릿에서 호출하든)이어야 한다.
