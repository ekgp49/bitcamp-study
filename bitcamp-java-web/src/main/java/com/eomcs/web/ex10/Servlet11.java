...
public class Servlet11 extends HttpServlet {
  ...
  protected void service(HttpServletRequest request, HttpServletResponse response)
    ...
    // 테스트 방법:
    // => http://localhost:9999/bitcamp-java-web/ex10/s11
    //

    // 쿠키 유효기간
    // => 유효기간을 설정하면 웹브라우저는 그 기간 동안에만 웹서버에게 쿠키를 보낸다.
    // => HTTP 응답 프로토콜

    // HTTP/1.1 200
    // Set-Cookie: v1=aaa <---- 유효기간이 설정되지 않은 쿠키
    // Set-Cookie: v2=bbb; Max-Age=30; Expires=Wed, 08-Apr-2020 02:41:36 GMT
    // Set-Cookie: v3=ccc; Max-Age=60; Expires=Wed, 08-Apr-2020 02:42:06 GMT
    // Content-Type: text/plain;charset=UTF-8
    // Content-Length: 37
    // Date: Wed, 08 Apr 2020 02:41:06 GMT
