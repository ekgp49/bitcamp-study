...
public class Exam0113 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        // 따라서 위 예제를 Linux, mac OS, Unix의 CLI(Command Line Interface; 콘솔창/명령창)에서 실행하면 
        // 정상적으로 한글 문자열이 출력되지만
        // 윈도우에서 실행하면 한글 문자열이 깨진다.
        // 이유? 
        // => Linux, mac OS, Unix의 기본 문자 코드표는 UTF-8이다.
        ...
        // => JVM 실행 옵션에 다음을 추가하라. -Dfile.encoding=utf-8
        // => java -Dfile.encoding=utf-8
        // => PowerShell이 아닌 Command 창에서 실행하라.
