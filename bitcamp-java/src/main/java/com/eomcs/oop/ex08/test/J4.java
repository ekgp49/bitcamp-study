...
public class J4 {
  ...
  // 서브클래스에서 반드시 재정의 해야하는 메서드는 문법으로 강제시킬 수 있다.
  // => 추상 메서드
  ...
  // 수퍼 클래스의 모든 추상 클래스를 구현해야만 일반 클래스(concrete class) 가 될 수 있다.
