...
public class MyAdvice {
  ...
  /*
   * <aop:before pointcut="execution(* com.eomcs.spring.ioc.ex13.f.X.*(..)) and args(a,b)"
   * method="doBefore"/>
   */
  ...
  /*
   * <aop:after-returning pointcut="execution(* com.eomcs.spring.ioc.ex13.f.X.*(..))"
  ...
  // => 설정 파일에 정의된 이름을 사용하여 파라미터를 선언해야 한다.
  /*
   * <aop:after-throwing pointcut="execution(* com.eomcs.spring.ioc.ex13.f.X.*(..))"
