...
// @ComponentScan
// => <context:component-scan/>과 같은 일을 한다.

// 사용법 1: 한개의 패키지를 지정하기
// @ComponentScan(basePackages = {"com.eomcs.spring.ioc.ex11.p1"})
// => 배열 항목이 한개일 경우 중괄호 생략 가능
// @ComponentScan(basePackages = "com.eomcs.spring.ioc.ex11.p1")
...
//// <context:exclude-filter type="regex" expression="com.eomcs.spring.ioc.ex11.p2.*"/>
