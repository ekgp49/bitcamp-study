...
public class Exam0230 {
  ...
  public static void main(String[] args) {
    ...
    // => contains()는 각 객체애 대해 equals()를 호출하여 비교한다.
    // => 따라서 equals()를 오버라이딩 하지 않은 경우,
    // contains() 결과는 원하는대로 나오지 않을 것이다.

    // 그냥 모든 domain 클래스는 무조건 equals()와 hashCode()를 오버라이딩하라
    // hashCode()를 오버라이딩하는 이유?
    // => HashSet과 HashMap 들을 사용할 때는 hashCode()를 사용한다.
  }
