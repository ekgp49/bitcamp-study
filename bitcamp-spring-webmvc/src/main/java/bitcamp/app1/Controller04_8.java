...
public class Controller04_8 {
  ...
  // => Servlet API에서 제공하는 Part 또는 Spring에서 제공하는 MultipartFile 타입의
  // 아규먼트를 선언하면 된다.
  //
  // 주의!
  ...
  // MultipartFile을 쓰려면(스프링방식) AppConfig 에서 MultipartResolver 객체를 등록해야 한다.
  // 테스트:
  // http://.../html/app1/c04_8.html
  ...
  @ResponseBody
  public String handler3(String name, int age,
