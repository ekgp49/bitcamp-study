...
public class WebApplicationInitializerImpl
  ...
  protected Class<?>[] getRootConfigClasses() {
    System.out.println("getRootConfigClasses() 실행");
    return null;
  }

  @Override
  protected Class<?>[] getServletConfigClasses() {
    System.out.println("getServletConfigClasses() 실행");
  ...
  protected String[] getServletMappings() {
    System.out.println("getServletMappings() 실행");
  ...
  protected String getServletName() {
    System.out.println("getServletName() 실행");
    // 스프링 Web MVC 프레임워크는
